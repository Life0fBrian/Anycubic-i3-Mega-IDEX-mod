...
This project is currently still in its design phase and has not been brought to life yet.
It uses a 1515 aluminum extrusion and MGN12 linear rail for the X gantry.
(The printer itself will get a linear rail mod for the bed as well.)
